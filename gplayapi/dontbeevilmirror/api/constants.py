# https://github.com/onyxbits/raccoon4/blob/923610fe8fadb6d7426283d99a7b0b4d538692f4/src/main/java/com/akdeniz/googleplaycrawler/Utils.java#L210-L542

SYSTEM_SHARED_LIBRARIES = [
    "libhoaeffects.qti.so",
    "libFood.camera.samsung.so",
    "libFacePreProcessing_jni.camera.samsung.so",
    "lib_nativeJni.dk.samsung.so",
    ...
    "libBright_core.camera.samsung.so",
    "liblistenjni.qti.so",
    ...
    "libhal.wsm.samsung.so",
    "libFoodDetector.camera.samsung.so",
    "libcolor_engine.camera.samsung.so",
    "libSDKRecognitionText.spensdk.samsung.so",
    "libsuperresolution.arcsoft.so",
    "lib_native_client.dk.samsung.so",
    "sem-telephony-common",
    "libss_jni.securestorage.samsung.so",
    ...
    "libperfsdk.performance.samsung.so",
    "qti-telephony-utils",
    ...
    "secimaging",
    "semextendedformat",
    "libsecphotoremaster.camera.samsung.so",
    "semmediatranscoder",
    ...
    "libBestComposition.polarr.so",
    "libYuv.polarr.so",
    "libface_landmark.arcsoft.so",
    "libFaceRestoration.camera.samsung.so",
    "libPolarrSnap.polarr.so",
    "org.apache.http.legacy",
    "libhigh_res.arcsoft.so",
...
SYSTEM_AVAILABLE_FEATURES = [
    ...
    "com.samsung.android.authfw.tahal",
